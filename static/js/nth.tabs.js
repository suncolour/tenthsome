...
(function ($) {
	$.fn.nthTabs =  function(options){
		...
		<li><a href="#" class="tab-location">按时间排序</a></li>\
		<li><a href="#" class="tab-close-current">按点赞量排序</a></li>\
		<li><a href="#" class="tab-close-other">按评论量排序</a></li>\
		...
		'<div class="dropdown roll-nav right-nav-list"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-chevron-down"></span></a><ul class="dropdown-menu"><li><a href="#" class="tab-location">定位当前选项卡</a></li><li><a href="#" class="tab-close-current">关闭当前选项卡</a></li><li role="separator" class="divider"></li><li><a href="#" class="tab-close-other">关闭其他选项卡</a></li><li><a href="#" class="tab-close-all">关闭全部选项卡</a></li><li role="separator" class="divider"></li><li class="scrollbar-outer tab-list-scrollbar"><div class="tab-list-container"><ul class="tab-list"></ul></div></li></ul></div></div>'
		//各种api
		var methods = {
			//初始化
			init:function () {
			...
			listen:function(){
				...
				event.onTabRollLeft().onTabRollRight().onTabList()
					.onTabCloseAll().onTabClose();
			},
			//获取所有tab宽度
